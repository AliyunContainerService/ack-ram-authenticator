...
import (
	...
	"github.com/AliyunContainerService/ack-ram-authenticator/pkg/mapper/configmap/client"
...
var addCmd = &cobra.Command{
	Use:   "add",
	Short: "add RAM entity to an existing alibabacloud-auth configmap",
}
...
var addRoleCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		checkPrompt(fmt.Sprintf("add %s, username %s, groups %s", roleARN, userName, groups))
		cli := createClient()
